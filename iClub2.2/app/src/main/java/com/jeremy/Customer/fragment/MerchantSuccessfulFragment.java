 ...
 */
public class MerchantSuccessfulFragment extends Fragment implements PullToRefreshBase.OnRefreshListener2<ListView>,View.OnClickListener {
    ...
    public MerchantSuccessfulFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_merchant_successful, container, false);
    ...
    private void intiData(int offset) {
        ...
        httpUtils.send(HttpRequest.HttpMethod.GET, AppUtilsUrl.getMerchantInvite(uid, "complete", offset), new RequestCallBack<String>() {
            @Override
