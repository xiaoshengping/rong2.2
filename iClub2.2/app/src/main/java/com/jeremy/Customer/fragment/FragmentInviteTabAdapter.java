 ...
 * Time: 上午9:25
 */
public class FragmentInviteTabAdapter implements RadioGroup.OnCheckedChangeListener {
    ...
    public FragmentInviteTabAdapter(FragmentActivity fragmentActivity, List<Fragment> fragments, int fragmentContentId, RadioGroup rgs) {
