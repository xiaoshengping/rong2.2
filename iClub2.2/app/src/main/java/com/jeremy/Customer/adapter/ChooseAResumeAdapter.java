 ...
 */
public class ChooseAResumeAdapter  extends AppBaseAdapter<TalentValueBean>   {
    ...
    public ChooseAResumeAdapter(List<TalentValueBean> data, Context context,PullToRefreshListView resumeListLv) {
        super(data, context);
